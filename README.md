...
Pet-проект для автоматизации тестирования веб-приложений на трех уровнях:
...
- CRUD + фильтрация + комментарии + схемы + негативные кейсы для JSONPlaceholder API
- Ключевые UI-флоу демо-приложения SauceDemo: логин, корзина, подсчет товаров, checkout
- Проверка схемы БД, внешних ключей, уникальности email, согласованности цен и транзакций в PostgreSQL